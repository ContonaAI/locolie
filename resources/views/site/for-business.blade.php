...
@section('meta_description', 'List your independent business on locolie for free. Reach local shoppers in Newcastle NE1, run offers, and upgrade for priority placement, push and email from £19/mo.')
...
<section class="relative overflow-hidden hero-grid">
    ...
    <div class="relative mx-auto max-w-4xl px-5 pb-14 pt-32 text-center sm:px-6 lg:pt-40">
        ...
        <h1 class="mt-6 text-4xl font-extrabold leading-[1.05] tracking-tight text-balance sm:text-5xl lg:text-6xl">
            Get found by locals who want to <span class="text-emerald">shop independent</span>.
        </h1>
        <p class="mx-auto mt-5 max-w-xl text-lg leading-relaxed text-muted">
            locolie puts your shop on the map for nearby shoppers actively looking for independents - not chains. Claim your listing free, publish offers, and only pay when you want more reach.
        </p>
...
<section class="py-20 sm:py-24">
    <div class="mx-auto max-w-6xl px-5 sm:px-6">
        <div class="grid gap-6 md:grid-cols-3">
            @php
                $values = [
                    ['title' => 'Reach nearby shoppers', 'body' => 'Appear in the map and feed of locals browsing for independents in your area - exactly when they\'re deciding where to go.',
                     'icon' => '<path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0Z"/><circle cx="12" cy="10" r="3"/>'],
                    ['title' => 'Run offers that convert', 'body' => 'Publish one-time offer codes redeemed at the till via QR - so you can measure exactly what footfall an offer drives.',
                     'icon' => '<path d="M20.59 13.41 13.42 20.6a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82Z"/><line x1="7" y1="7" x2="7.01" y2="7"/>'],
                    ['title' => 'Pay only for growth', 'body' => 'The listing is free forever. Upgrade for featured placement, push notifications and email campaigns when you\'re ready.',
        ...
        <div class="grid items-center gap-12 lg:grid-cols-2">
            <div>
                ...
                <p class="mt-5 text-lg leading-relaxed text-white/70">
                    Every redemption captures a real customer - name, email, how often they visit - straight into <span class="font-semibold text-white">your own list</span>. It’s the loyalty data Tesco, Greggs and Costa built billion-pound businesses on, and that independents have never had.
                </p>
                <p class="mt-4 text-lg leading-relaxed text-white/70">
                    Stop renting reach from Facebook and Deliveroo. Bring your regulars back with your own email &amp; push offers - and keep the relationship for good.
                </p>
...
<section class="py-20 sm:py-28">
    <div class="mx-auto max-w-6xl px-5 sm:px-6">
        <div class="mx-auto max-w-2xl text-center">
            ...
            <p class="mt-4 text-muted">Once a shopper redeems with you they're on your list. Bring them back with built-in email, SMS and push - no separate Mailchimp, no agency, no ad spend.</p>
        </div>
        <div class="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            @php
                $tools = [
                    ...
                    ['SMS / text blasts', 'Last-minute table free? Quiet Tuesday? Text your regulars and fill it - texts get read in minutes.',
                     '<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>'],
                    ['Push notifications', 'Ping nearby shoppers and your followers when you drop a new offer (Premium).',
                     '<path d="M18 8a6 6 0 0 0-12 0c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.7 21a2 2 0 0 1-3.4 0"/>'],
                    ['Win-back automations', 'Automatic "we miss you" and birthday offers that bring lapsed customers back on autopilot.',
        ...
        <p class="mt-8 text-center text-sm text-muted">All from one dashboard, with the customer list you actually own.</p>
    </div>
</section>
...
<section id="pricing" class="border-y border-hair bg-[#f5f5f5] py-20 sm:py-28">
    <div class="mx-auto max-w-6xl px-5 sm:px-6">
        <div class="mx-auto max-w-2xl text-center">
            ...
            <p class="mt-4 text-muted">Start on the free plan and upgrade whenever you want more reach. No contracts, no setup fees.</p>
        </div>
...
<section class="py-20 sm:py-28">
    <div class="mx-auto max-w-6xl px-5 sm:px-6">
        <div class="mx-auto max-w-2xl text-center">
            <h2 class="text-xs font-semibold uppercase tracking-wider text-emerald">Onboarding</h2>
        ...
        <div class="mx-auto mt-14 grid max-w-4xl gap-8 sm:grid-cols-2 lg:grid-cols-4">
            @php
                $onboard = [
                    ['n' => '1', 'title' => 'Claim your listing', 'body' => 'Find your business (or add it) and verify you\'re the owner.'],
                    ['n' => '2', 'title' => 'Add your details', 'body' => 'Photos, hours, description - make your profile shine.'],
                    ['n' => '3', 'title' => 'Publish an offer', 'body' => 'Create your first deal and we\'ll generate the redemption QR.'],
                    ['n' => '4', 'title' => 'Go live', 'body' => 'You\'re on the map. Print the window sticker and welcome shoppers.'],
                ];
            @endphp
...
<section class="border-t border-hair py-20 sm:py-28">
    <div class="mx-auto max-w-3xl px-5 sm:px-6">
        ...
        <div class="mt-12 space-y-3" x-data="{ open: 0 }">
            @php
                $faqs = [
                    ['q' => 'Is it really free to list?', 'a' => 'Yes. The Free plan is free forever - you get listed in search and on the map, can publish offers, and redeem them via QR at the till. You only pay if you choose a paid plan for extra reach.'],
                    ['q' => 'Who can join locolie?', 'a' => 'locolie is exclusively for independent UK local businesses. We don\'t list national chains - that\'s the whole point. We\'re launching in Newcastle NE1 first.'],
                    ['q' => 'How do offer redemptions work?', 'a' => 'You publish an offer, a shopper reveals its code in the app, and at the till you scan their QR (or they scan your window sticker). The redemption is logged so you can see exactly what each offer drove.'],
                    ['q' => 'What\'s the difference between Featured and Premium?', 'a' => 'Featured (£19/mo) gives you featured-rail placement, a "Sponsored" badge, priority in search and map, and a monthly email feature. Premium (£49/mo) adds top placement, push notifications to nearby shoppers, unlimited email campaigns and an analytics dashboard.'],
                    ['q' => 'Can I cancel or change plan anytime?', 'a' => 'Absolutely. There are no contracts. Upgrade, downgrade or cancel whenever you like - changes take effect from your next billing cycle.'],
                    ['q' => 'Do I really get to keep my customer data?', 'a' => 'Yes - that\'s the whole point. Every shopper who redeems an offer is captured into your own customer list (name, email, visit count), which you can export anytime and market to with email and push. Customers opt in to marketing, and it\'s all GDPR-compliant - but the relationship is yours, not ours and not a chain\'s.'],
                ];
            @endphp
            @push('head')
...
<section class="border-t border-hair bg-ink py-20 text-center text-white sm:py-24">
    <div class="mx-auto max-w-2xl px-5 sm:px-6">
        <h2 class="text-3xl font-extrabold tracking-tight sm:text-4xl text-balance">Put your business on the map.</h2>
        <p class="mt-4 text-white/70">Join the independents already on locolie in Newcastle NE1. It's free to start.</p>
