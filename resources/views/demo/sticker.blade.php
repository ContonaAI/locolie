...
<style>
  :root{ --ink:#0F2D38; --accent:#D9603B; --cta:#FFA41C; }
  *{ box-sizing:border-box; }
  ...
  .pin{ display:inline-block; width:.5em; height:.5em; background:var(--accent); border-radius:50% 50% 50% 0; transform:rotate(-45deg); margin:0 .04em; }
...
<body>
  ...
  <div class="sticker">
    <div class="brand">Go<span class="pin"></span>Local</div>
...
<script>
  new QRCode(document.getElementById('qr'), {
    ...
    colorDark: '#0F2D38', colorLight: '#ffffff',
